    ...
    runTestsOnline(() {
      ...
      test(
        ...
        () async {
          // arrange
          when(mockRemoteDataSource.getConcreteNumberTrivia(any))
              .thenThrow(const AppException.server());
          // act
          final result = await repository.getConcreteNumberTrivia(tNumber);
          // assert
          verify(mockRemoteDataSource.getConcreteNumberTrivia(tNumber));
          ...
          expect(
            result,
            equals(const Left<Failure, NumberTrivia>(Failure.server())),
          );
        },
      );
    });
    ...
    runTestsOffline(() {
      ...
      test(
        ...
        () async {
          // arrange
          when(mockLocalDataSource.getLastNumberTrivia())
              .thenThrow(const AppException.cache());
          // act
          final result = await repository.getConcreteNumberTrivia(tNumber);
          // assert
          verifyZeroInteractions(mockRemoteDataSource);
          ...
          expect(
            result,
            equals(const Left<Failure, NumberTrivia>(Failure.cache())),
          );
        },
      );
    });
